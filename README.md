...
- Current-session, latest-only, and fullscreen states expose `aria-*` markers and highlighted toggle buttons for better keyboard and assistive-technology readability.
