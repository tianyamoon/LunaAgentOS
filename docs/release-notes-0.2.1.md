...
- **OpenAI Codex promoted into current entry messaging**: the README now describes Claude Code, Hermes, and OpenAI Codex together as current multi-provider agent entries.
